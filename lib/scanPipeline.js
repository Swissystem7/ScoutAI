...
function selftest() {
  ...
  const proof = require('../attic/proof-demo.js').PLAYERS.map((p, i) => ({ id: 'proof-' + i, name: p.name, source: 'story', statScore: p.statScore, momentum: p.momentumRaw, energyFeatures: p.features, leagueStrength: i === 1 ? 0.3 : 0.6 }));
